...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 z-50 w-full transition-all duration-500 ${isScrolled ? 'bg-zinc-900/95 shadow-lg' : 'bg-gradient-to-b from-black/80 to-transparent'}`}>
      <div className="mx-auto flex items-center justify-between px-4 py-4">
        <div className="flex items-center space-x-8">
          <svg viewBox="0 0 111 30" className="h-6 w-24 fill-red-600">
